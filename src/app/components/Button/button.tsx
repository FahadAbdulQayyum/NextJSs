...
const CustomButton = ({ children, disabled, subNav, sub, btn }: any) => {
    ...
    return (
        <div
            ...
            // className={`p-2 text-yellow-50 ${!disabled ? 'hover:border-b-2 hover:border-t-2 hover:border-t-transparent hover:pt-[5px]' : ''} hover:cursor-pointer duration-1000 translate-x-1 flex items-center ${cssStyle.fahad} ${subNav ? 'space-x-1' : ''} ${cssStyle.show} ${btn && 'bg-blue-400 rounded-lg px-5 font-bold hover:bg-orange-950'} ${subNav ? 'hover:pb-48' : ''}`}
        ...
        // className={`p-2 text-yellow-50 ${!disabled ? 'hover:border-b-2 hover:border-t-2 hover:border-t-transparent hover:pt-[5px]' : ''} hover:cursor-pointer duration-1000 translate-x-1 flex items-center ${cssStyle.fahad} ${subNav ? 'space-x-1' : ''} ${cssStyle.show} ${btn && 'bg-blue-400 rounded-lg px-5 font-bold hover:bg-orange-950'}`}
